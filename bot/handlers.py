...
_DELEGATED_NAMES: Dict[str, Tuple[str, str]] = {
    ...
    "ADD_POSTER_EDIT": ("bot.handlers_add_flow", "ADD_POSTER_EDIT"),
    "ADD_POSTER_EDIT_TEXT": ("bot.handlers_add_flow", "ADD_POSTER_EDIT_TEXT"),
    ...
    "add_flow_poster_edit_text_start": ("bot.handlers_add_flow", "add_flow_poster_edit_text_start"),
    "add_flow_poster_edit_open": ("bot.handlers_add_flow", "add_flow_poster_edit_open"),
    "add_flow_poster_edit_set_type": ("bot.handlers_add_flow", "add_flow_poster_edit_set_type"),
    "add_flow_poster_edit_set_recommendation": ("bot.handlers_add_flow", "add_flow_poster_edit_set_recommendation"),
    "add_flow_poster_edit_set_owner": ("bot.handlers_add_flow", "add_flow_poster_edit_set_owner"),
    "add_flow_poster_edit_back": ("bot.handlers_add_flow", "add_flow_poster_edit_back"),
    "add_flow_poster_edit_text_value": ("bot.handlers_add_flow", "add_flow_poster_edit_text_value"),
    ...
    "diag_command": ("bot.handlers_diag", "diag_command"),
